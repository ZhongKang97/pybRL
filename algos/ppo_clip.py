...
class PPO(BatchREINFORCE):
    ...
    def train_from_paths(self, paths):
        ...
        # --------------------------
        surr_before = self.compute_reinforce_loss(observations, actions, advantages).data.numpy().ravel()[0]
        ...
        surr_after = self.compute_reinforce_loss(observations, actions, advantages).data.numpy().ravel()[0]
